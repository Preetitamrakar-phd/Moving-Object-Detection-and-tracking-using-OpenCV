...
firstFrame=None   # first should capture the backgroung
area = 500     #how much movement it should detect

while True:
    _,img = cam.read() # Read from camera
    text = "Normal"
    img = imutils.resize(img, width=500) #resizing for proper display
